...
import ScrappyInuLogo from '../../assets/images/ScrappyInu-logo.png'
...
export default function CurrencyLogo({
  ...
  } else if (currency?.equals(ScrappyInu[SupportedChainId.MAINNET]) || currency?.equals(ScrappyInu[SupportedChainId.TESTNET])) {
    return <StyledBinanceLogo src={ScrappyInuLogo} size={size} style={style} {...rest} />
  }
