...
import { ScrappyInu_ADDRESS } from './addresses'
...
export const ScrappyInu: { [chainId: number]: Token } = {
  [SupportedChainId.MAINNET]: new Token(
    SupportedChainId.MAINNET,
    ScrappyInu_ADDRESS[SupportedChainId.MAINNET],
    18,
    'ScrappyInu',
    'ScrappyInu'
  ),
  [SupportedChainId.TESTNET]: new Token(
    SupportedChainId.TESTNET,
    ScrappyInu_ADDRESS[SupportedChainId.TESTNET],
    18,
    'ScrappyInu',
    'ScrappyInu'
  ),
