            ...
            <AutoColumn gap="md">
                ...
                <TYPE.white fontWeight={600}>
                  <Trans>
                    {stakingInfo.stakedPairTokens
                      ? `Step 1. Get ScrappyInu-V2 Liquidity tokens`
              ...
              <RowBetween style={{ marginBottom: '1rem' }}>
                <TYPE.white fontSize={14}>
                  <Trans>
                    {stakingInfo.stakedPairTokens
                      ? `ScrappyInu-V2 LP tokens are required. Once you've added liquidity to the ${currency0?.symbol}-
        ...
        {!userLiquidityUnstaked ? null : userLiquidityUnstaked.equalTo('0') ? null : (
          <TYPE.main>
            <Trans>
              ...
              {stakingInfo.stakedPairTokens
                ? ` ScrappyInu-V2 LP tokens available`
