            ...
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>
                  <Trans>ScrappyInu staking and liquidity mining</Trans>
                </TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  <Trans>Deposit your Liquidity Provider tokens to receive ScrappyInu, the ScrappyInu protocol token.</Trans>
                </TYPE.white>
              </RowBetween>{' '}
              <ExternalLink
