...
import { Trade as V2Trade } from '@ScrappyInu/sdk'
import { splitSignature } from 'ethers/lib/utils'
import { useMemo, useState } from 'react'
import { DAI, ScrappyInu, USDC } from '../constants/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [SupportedChainId.MAINNET]: {
    ...
    [ScrappyInu[SupportedChainId.MAINNET].address]: { type: PermitType.AMOUNT, name: 'Uniswap' },
  },
  [SupportedChainId.TESTNET]: {
    [ScrappyInu[SupportedChainId.TESTNET].address]: { type: PermitType.AMOUNT, name: 'Uniswap' },
  },
}
