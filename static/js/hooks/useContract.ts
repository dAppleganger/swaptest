...
import { abi as ScrappyInu_ABI } from '@uniswap/governance/build/Uni.json'
...
import { ScrappyInu, WETH9_EXTENDED } from '../constants/tokens'
...
export function useUniContract() {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId ? ScrappyInu[chainId]?.address : undefined, ScrappyInu_ABI, true)
}
