...
import { Pair } from '@ScrappyInu/sdk'
import JSBI from 'jsbi'
import { useMemo } from 'react'
import { DAI, ScrappyInu, USDC, USDT, BTCB, WETH9_EXTENDED } from '../../constants/tokens'
...
export function useStakingInfo(): StakingInfo[] | undefined {
  ...
  const ScrappyInu = chainId ? ScrappyInu[chainId] : undefined
...
export function useTotalUniEarned(): CurrencyAmount<Token> | undefined {
  ...
  const uni = chainId ? ScrappyInu[chainId] : undefined
